...
export const fetchers = {
  ...
  providerModels: () => apiFetch('/providers/models'),
  ...
  usageSummary: () => apiFetch('/usage/summary'),

  usageDaily: (days = 30) =>
    apiFetch('/usage/daily', { params: { days: String(days) } }),

  usageByModel: () => apiFetch('/usage/by-model'),
};
